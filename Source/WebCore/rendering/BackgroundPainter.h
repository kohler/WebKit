...
public:
    ...
    void setImageRect(LayoutRect imageRect) { m_imageRect = imageRect; }
    ...
    static BackgroundImageGeometry calculateBackgroundImageGeometry(const RenderBoxModelObject&, const RenderLayerModelObject* paintContainer, const FillLayer&, const LayoutPoint& paintOffset, const LayoutRect& borderBoxRect, std::optional<LayoutRect> imageRect = std::nullopt);
